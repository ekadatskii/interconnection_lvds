...
#
# Generated by Vivado on Sat Mar 05 12:21:09 KGT 2016
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/fifo_serdes_1.0"] [file normalize "$origin_dir/stream_slave_1.0"] [file normalize "$origin_dir/stream_master_1.0"] [file normalize "$origin_dir/stream_controller_1.0"] [file normalize "$origin_dir/clk_gen_1.0"]" $obj
